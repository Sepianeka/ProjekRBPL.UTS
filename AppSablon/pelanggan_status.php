...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($action == 'setuju') {
        ...
        $conn->query("DELETE FROM orders WHERE id=$order_id AND status='Menunggu Verifikasi'");
    }
...
<body>
    <div class="mobile-container">
        <div class="top-header">
            <h2 class="top-header-title">Pesanan Anda</h2>
        ...
        <div class="content-area">
            ...
            <?php else: ?>
                ...
                <div class="card">
                    ...
                    <?php if($o['status'] == 'Menunggu Verifikasi'): ?>
                        <form action="" method="POST" style="margin-top: 16px;">
                            <input type="hidden" name="order_id" value="<?= $o['id'] ?>">
                            <button type="submit" name="action" value="batal" class="btn btn-outline" style="border-color: red; color: red; padding: 8px;" onclick="return confirm('Apakah Anda yakin ingin membatalkan pesanan ini?');">Batalkan Pesanan</button>
                        </form>
                    <?php endif; ?>
